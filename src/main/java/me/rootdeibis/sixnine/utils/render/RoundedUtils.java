package me.rootdeibis.sixnine.utils.render;

import me.rootdeibis.sixnine.utils.shaders.ShaderUtils;
import me.rootdeibis.sixnine.utils.color.ColorUtils;
...
public class RoundedUtils {
    ...
    public static ShaderUtils roundedShader = new ShaderUtils("sixnine/shaders/roundedRect.frag");
    public static ShaderUtils roundedOutlineShader = new ShaderUtils("sixnine/shaders/roundRectOutline.frag");
    private static ShaderUtils roundedTexturedShader = new ShaderUtils("sixnine/shaders/roundRectTextured.frag");
    private static ShaderUtils roundedGradientShader = new ShaderUtils("sixnine/shaders/roundedRectGradient.frag");
